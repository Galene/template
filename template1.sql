...
--
-- Host: localhost
-- Generation Time: Oct 23, 2013 at 03:08 PM
...
--
-- Table structure for table `bak_v3xha_assets`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_assets` (
...
--
-- Dumping data for table `bak_v3xha_assets`
--

INSERT INTO `bak_v3xha_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `bak_v3xha_associations`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_associations` (
...
--
-- Table structure for table `bak_v3xha_banners`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_banners` (
...
--
-- Table structure for table `bak_v3xha_banner_clients`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `bak_v3xha_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_banner_tracks` (
...
--
-- Table structure for table `bak_v3xha_categories`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_v3xha_categories`
--

INSERT INTO `bak_v3xha_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Table structure for table `bak_v3xha_contact_details`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `bak_v3xha_content`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_content` (
...
--
-- Table structure for table `bak_v3xha_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_content_frontpage` (
...
--
-- Table structure for table `bak_v3xha_content_rating`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_v3xha_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_core_log_searches` (
...
--
-- Table structure for table `bak_v3xha_extensions`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_extensions` (
...
--
-- Dumping data for table `bak_v3xha_extensions`
--

INSERT INTO `bak_v3xha_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `bak_v3xha_finder_filters`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_filters` (
...
--
-- Table structure for table `bak_v3xha_finder_links`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links` (
...
--
-- Table structure for table `bak_v3xha_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms0` (
...
--
-- Table structure for table `bak_v3xha_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_v3xha_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `bak_v3xha_finder_taxonomy`
--

INSERT INTO `bak_v3xha_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `bak_v3xha_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `bak_v3xha_finder_terms`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_terms` (
...
--
-- Table structure for table `bak_v3xha_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `bak_v3xha_finder_terms_common`
--

INSERT INTO `bak_v3xha_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `bak_v3xha_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_v3xha_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `bak_v3xha_finder_types`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_v3xha_languages`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_languages` (
...
--
-- Dumping data for table `bak_v3xha_languages`
--

INSERT INTO `bak_v3xha_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `bak_v3xha_menu`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_v3xha_menu`
--

INSERT INTO `bak_v3xha_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `bak_v3xha_menu_types`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_v3xha_menu_types`
--

INSERT INTO `bak_v3xha_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `bak_v3xha_messages`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_messages` (
...
--
-- Table structure for table `bak_v3xha_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_messages_cfg` (
...
--
-- Table structure for table `bak_v3xha_modules`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_v3xha_modules`
--

INSERT INTO `bak_v3xha_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `bak_v3xha_modules_menu`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_modules_menu` (
...
--
-- Dumping data for table `bak_v3xha_modules_menu`
--

INSERT INTO `bak_v3xha_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `bak_v3xha_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_v3xha_overrider`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_overrider` (
...
--
-- Table structure for table `bak_v3xha_redirect_links`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_v3xha_schemas`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_schemas` (
...
--
-- Dumping data for table `bak_v3xha_schemas`
--

INSERT INTO `bak_v3xha_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.14');

-- --------------------------------------------------------

--
-- Table structure for table `bak_v3xha_session`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_session` (
...
--
-- Dumping data for table `bak_v3xha_template_styles`
--

INSERT INTO `bak_v3xha_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `bak_v3xha_updates`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_updates` (
...
--
-- Table structure for table `bak_v3xha_update_categories`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_update_categories` (
...
--
-- Table structure for table `bak_v3xha_update_sites`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_update_sites` (
...
--
-- Dumping data for table `bak_v3xha_update_sites`
--

INSERT INTO `bak_v3xha_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
--
-- Table structure for table `bak_v3xha_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_update_sites_extensions` (
...
--
-- Dumping data for table `bak_v3xha_update_sites_extensions`
--

INSERT INTO `bak_v3xha_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `bak_v3xha_usergroups`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `bak_v3xha_usergroups`
--

INSERT INTO `bak_v3xha_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `bak_v3xha_users`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bak_v3xha_users`
--

INSERT INTO `bak_v3xha_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(804, 'Super User', 'admin', 'galina.ck@gmail.com', '9c8614c804898c5d824da0be177f1131:NKvatN2RJ1KaAOcE0XB3d8yv7jfDthW0', 'deprecated', 0, 1, '2013-10-20 18:15:46', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bak_v3xha_user_notes`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_v3xha_user_profiles`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_user_profiles` (
...
--
-- Table structure for table `bak_v3xha_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_user_usergroup_map` (
...
--
-- Dumping data for table `bak_v3xha_user_usergroup_map`
--

INSERT INTO `bak_v3xha_user_usergroup_map` (`user_id`, `group_id`) VALUES
(804, 8);

-- --------------------------------------------------------

--
-- Table structure for table `bak_v3xha_viewlevels`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `bak_v3xha_viewlevels`
--

INSERT INTO `bak_v3xha_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `bak_v3xha_weblinks`
--

CREATE TABLE IF NOT EXISTS `bak_v3xha_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `v3xha_assets`
--

CREATE TABLE IF NOT EXISTS `v3xha_assets` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set parent.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `v3xha_assets`
--

INSERT INTO `v3xha_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 27, 21, 22, 3, 'com_content.article.1', 'History', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(36, 38, 27, 28, 3, 'com_content.article.2', 'Article 3.1', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(37, 38, 29, 30, 3, 'com_content.article.3', 'Article 3.2', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(38, 8, 26, 31, 2, 'com_content.category.8', 'Cat. for menu', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(39, 8, 32, 39, 2, 'com_content.category.9', 'News', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(40, 39, 33, 34, 3, 'com_content.article.4', 'News1', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(41, 39, 35, 36, 3, 'com_content.article.5', 'News2', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(42, 39, 37, 38, 3, 'com_content.article.6', 'News3', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(43, 7, 16, 17, 2, 'com_contact.category.10', 'Contacts', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(44, 27, 23, 24, 3, 'com_content.article.7', 'Most Read', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(45, 1, 89, 92, 1, 'com_djimageslider', 'com_djimageslider', '{}'),
(46, 45, 90, 91, 2, 'com_djimageslider.category.11', 'Slider', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(47, 8, 40, 41, 2, 'com_content.category.12', 'Slider', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_associations`
--

CREATE TABLE IF NOT EXISTS `v3xha_associations` (
  `id` varchar(50) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
  PRIMARY KEY (`context`,`id`),
...
--
-- Table structure for table `v3xha_banners`
--

CREATE TABLE IF NOT EXISTS `v3xha_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL DEFAULT '0',
  `type` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `v3xha_banner_clients`
--

CREATE TABLE IF NOT EXISTS `v3xha_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `contact` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `v3xha_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `v3xha_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) unsigned NOT NULL,
  `banner_id` int(10) unsigned NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `v3xha_categories`
--

CREATE TABLE IF NOT EXISTS `v3xha_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `v3xha_categories`
--

INSERT INTO `v3xha_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:28:33', 0, '0000-00-00 00:00:00', 0, '*'),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:28:33', 0, '0000-00-00 00:00:00', 0, '*'),
(8, 38, 1, 13, 14, 1, 'cat-for-menu', 'com_content', 'Cat. for menu', 'cat-for-menu', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 316, '2013-10-21 14:39:57', 0, '0000-00-00 00:00:00', 0, '*'),
(9, 39, 1, 15, 16, 1, 'news', 'com_content', 'News', 'news', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 316, '2013-10-21 14:55:29', 0, '0000-00-00 00:00:00', 0, '*'),
(10, 43, 1, 17, 18, 1, 'contacts', 'com_contact', 'Contacts', 'contacts', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 316, '2013-10-21 15:37:26', 0, '0000-00-00 00:00:00', 0, '*'),
(11, 46, 1, 19, 20, 1, 'slider', 'com_djimageslider', 'Slider', 'slider', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 316, '2013-10-23 11:22:28', 0, '0000-00-00 00:00:00', 0, '*'),
(12, 47, 1, 21, 22, 1, 'slider', 'com_content', 'Slider', 'slider', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 316, '2013-10-23 11:45:52', 0, '0000-00-00 00:00:00', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_contact_details`
--

CREATE TABLE IF NOT EXISTS `v3xha_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `con_position` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `v3xha_contact_details`
--

INSERT INTO `v3xha_contact_details` (`id`, `name`, `alias`, `con_position`, `address`, `suburb`, `state`, `country`, `postcode`, `telephone`, `fax`, `misc`, `image`, `imagepos`, `email_to`, `default_con`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `user_id`, `catid`, `access`, `mobile`, `webpage`, `sortname1`, `sortname2`, `sortname3`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `featured`, `xreference`, `publish_up`, `publish_down`) VALUES
(1, 'Email', 'email', '', '', '', '', '', '', '', '', '', '', NULL, 'email@gmail.com', 0, 1, 0, '0000-00-00 00:00:00', 1, '{"show_contact_category":"","show_contact_list":"","presentation_style":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","show_profile":"","show_links":"","linka_name":"","linka":false,"linkb_name":"","linkb":false,"linkc_name":"","linkc":false,"linkd_name":"","linkd":false,"linke_name":"","linke":"","contact_layout":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":""}', 0, 10, 1, '', '', '', '', '', '*', '2013-10-21 15:38:26', 316, '', '0000-00-00 00:00:00', 0, '', '', '{"robots":"","rights":""}', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_content`
--

CREATE TABLE IF NOT EXISTS `v3xha_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `v3xha_content`
--

INSERT INTO `v3xha_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 35, 'History', 'history', '', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur non metus ligula. Morbi id leo vestibulum, auctor massa at, eleifend leo. Curabitur at nisi mollis, elementum lorem a, mattis elit. Nullam vel magna tincidunt, pulvinar nisi vitae, euismod sem. Proin vestibulum consequat mauris sed elementum. Etiam sit amet turpis at dolor mattis fermentum. Aliquam pretium velit id orci semper, quis faucibus lorem accumsan. Aenean varius ultricies nulla varius pulvinar. Donec orci lorem, tristique eu metus sit amet, pellentesque dictum lorem. Integer sit amet felis in diam malesuada fringilla sit amet et nibh.</p>\r\n<p>Suspendisse dapibus sem semper purus dignissim interdum. Phasellus pretium sapien eget lorem congue tincidunt. Vivamus quis hendrerit massa, in varius mi. Suspendisse porta ullamcorper rhoncus. Proin facilisis quam magna, in faucibus mauris vehicula a. Duis in mauris at mi auctor cursus. Sed magna ante, interdum vel ornare ac, lobortis a tortor. Vestibulum ultricies suscipit ullamcorper. Quisque varius metus metus, a hendrerit ante consectetur eu. Vestibulum cursus quis libero nec aliquam. Pellentesque luctus luctus imperdiet.</p>', '', 1, 0, 0, 2, '2013-10-21 14:20:20', 316, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-21 14:20:20', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 1, '', '', 1, 16, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 36, 'Article 3.1', 'article-3-1', '', '<p>Phasellus non dictum sapien, laoreet facilisis ipsum. Curabitur in volutpat est, vitae convallis enim. Nullam a nibh quis est eleifend congue at id mauris. Mauris nisi leo, facilisis lacinia sem in, bibendum luctus nisi. Cras vel odio venenatis, tempor leo eu, dignissim augue. Integer non tellus orci. Duis sollicitudin ligula vel libero tempor pellentesque. Nam ornare sapien ac dictum elementum. Cras varius faucibus eros et ullamcorper. Etiam id orci vel neque commodo tempor.</p>\r\n<p>Nulla aliquam elementum est, ut gravida dui gravida eu. Nullam gravida mauris quis vestibulum accumsan. Phasellus sit amet dictum enim. Etiam volutpat ante velit, a auctor urna congue nec. Morbi sollicitudin faucibus mi quis lacinia. In tellus sapien, blandit sit amet mattis sed, pharetra sit amet nisi. Praesent ipsum mi, auctor sit amet nisi at, commodo molestie enim. Praesent sit amet neque a sem convallis rutrum. Maecenas nec hendrerit dolor.</p>', '', 1, 0, 0, 8, '2013-10-21 14:27:56', 316, '', '2013-10-21 14:40:14', 316, 0, '0000-00-00 00:00:00', '2013-10-21 14:27:56', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 0, 1, '', '', 1, 2, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 37, 'Article 3.2', 'article-3-2', '', '<p>Nulla aliquam elementum est, ut gravida dui gravida eu. Nullam gravida mauris quis vestibulum accumsan. Phasellus sit amet dictum enim. Etiam volutpat ante velit, a auctor urna congue nec. Morbi sollicitudin faucibus mi quis lacinia. In tellus sapien, blandit sit amet mattis sed, pharetra sit amet nisi. Praesent ipsum mi, auctor sit amet nisi at, commodo molestie enim. Praesent sit amet neque a sem convallis rutrum. Maecenas nec hendrerit dolor.</p>\r\n<p>Aenean nec elit ut arcu tincidunt eleifend. Morbi sed commodo lectus. Maecenas sagittis leo a sem aliquam aliquet. Ut id nibh eu purus pretium elementum eu sit amet lorem. Sed pretium dui vel erat consectetur, in luctus tortor imperdiet. Donec sit amet lectus elementum, consequat magna et, ultricies turpis. Sed lacinia massa sit amet odio scelerisque posuere. Sed tristique mattis mi.</p>\r\n<p><img src="images/lipsum05.gif" border="0" alt="" /></p>', '', 1, 0, 0, 8, '2013-10-21 14:29:35', 316, '', '2013-10-21 14:40:22', 316, 0, '0000-00-00 00:00:00', '2013-10-21 14:29:35', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 0, 0, '', '', 1, 3, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 40, 'News1', 'news1', '', '<p><em><strong>Curabitur non metus ligula</strong></em></p>\r\n<p>Curabitur non metus ligula. Morbi id leo vestibulum, auctor massa at, eleifend leo. Curabitur at nisi mollis, elementum lorem a, mattis elit. Nullam vel magna tincidunt, pulvinar nisi vitae, euismod sem. Proin vestibulum consequat mauris sed elementum. Etiam sit amet turpis at dolor mattis fermentum. Aliquam pretium velit id orci semper, quis faucibus lorem accumsan. Aenean varius ultricies nulla varius pulvinar. Donec orci lorem, tristique eu metus sit amet, pellentesque dictum lorem. Integer sit amet felis in diam malesuada fringilla sit amet et nibh.</p>', '', 1, 0, 0, 9, '2013-10-21 14:56:31', 316, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-21 14:56:31', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 2, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(5, 41, 'News2', 'news2', '', '<p><em><strong>Suspendisse dapibus</strong></em></p>\r\n<p>Suspendisse dapibus sem semper purus dignissim interdum. Phasellus pretium sapien eget lorem congue tincidunt. Vivamus quis hendrerit massa, in varius mi. Suspendisse porta ullamcorper rhoncus. Proin facilisis quam magna, in faucibus mauris vehicula a. Duis in mauris at mi auctor cursus. Sed magna ante, interdum vel ornare ac, lobortis a tortor. Vestibulum ultricies suscipit ullamcorper. Quisque varius metus metus, a hendrerit ante consectetur eu. Vestibulum cursus quis libero nec aliquam. Pellentesque luctus luctus imperdiet.</p>', '', 1, 0, 0, 9, '2013-10-21 14:57:18', 316, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-21 14:57:18', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(6, 42, 'News3', 'news3', '', '<p><strong><em>Phasellus non dictum</em> </strong></p>\r\n<p>Phasellus non dictum sapien, laoreet facilisis ipsum. Curabitur in volutpat est, vitae convallis enim. Nullam a nibh quis est eleifend congue at id mauris. Mauris nisi leo, facilisis lacinia sem in, bibendum luctus nisi. Cras vel odio venenatis, tempor leo eu, dignissim augue. Integer non tellus orci. Duis sollicitudin ligula vel libero tempor pellentesque. Nam ornare sapien ac dictum elementum. Cras varius faucibus eros et ullamcorper. Etiam id orci vel neque commodo tempor.</p>\r\n<p> </p>', '', 1, 0, 0, 9, '2013-10-21 14:58:03', 316, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-21 14:58:03', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(7, 44, 'Most Read', 'most-read', '', '<p>Most Read</p>', '', 0, 0, 0, 2, '2013-10-23 09:31:26', 316, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-23 09:31:26', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `v3xha_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `v3xha_content_rating`
--

CREATE TABLE IF NOT EXISTS `v3xha_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) unsigned NOT NULL DEFAULT '0',
  `rating_count` int(10) unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `v3xha_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `v3xha_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `v3xha_djimageslider`
--

CREATE TABLE IF NOT EXISTS `v3xha_djimageslider` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `v3xha_djimageslider`
--

INSERT INTO `v3xha_djimageslider` (`id`, `catid`, `title`, `alias`, `image`, `description`, `published`, `publish_up`, `publish_down`, `checked_out`, `checked_out_time`, `ordering`, `params`) VALUES
(1, 11, 'S1', 's1', 'images/slider/Bluesky-Orchid-Flower-Wallpaper.jpg', '', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 1, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","link_target":""}');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_extensions`
--

CREATE TABLE IF NOT EXISTS `v3xha_extensions` (
  `extension_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
...
--
-- Dumping data for table `v3xha_extensions`
--

INSERT INTO `v3xha_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(1, 'com_mailto', 'component', 'com_mailto', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_mailto","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_MAILTO_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(2, 'com_wrapper', 'component', 'com_wrapper', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_wrapper","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_WRAPPER_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(3, 'com_admin', 'component', 'com_admin', '', 1, 1, 1, 1, '{"legacy":false,"name":"com_admin","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_ADMIN_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(4, 'com_banners', 'component', 'com_banners', '', 1, 1, 1, 0, '{"legacy":false,"name":"com_banners","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_BANNERS_XML_DESCRIPTION","group":""}', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(415, 'plg_editors-xtd_pagebreak', 'plugin', 'pagebreak', 'editors-xtd', 0, 1, 1, 0, '{"legacy":false,"name":"plg_editors-xtd_pagebreak","type":"plugin","creationDate":"August 2004","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_EDITORSXTD_PAGEBREAK_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 3, 0),
(416, 'plg_editors-xtd_readmore', 'plugin', 'readmore', 'editors-xtd', 0, 1, 1, 0, '{"legacy":false,"name":"plg_editors-xtd_readmore","type":"plugin","creationDate":"March 2006","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_READMORE_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 4, 0),
(417, 'plg_search_categories', 'plugin', 'categories', 'search', 0, 1, 1, 0, '{"legacy":false,"name":"plg_search_categories","type":"plugin","creationDate":"November 2005","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_SEARCH_CATEGORIES_XML_DESCRIPTION","group":""}', '{"search_limit":"50","search_content":"1","search_archived":"1"}', '', '', 316, '2013-10-23 09:04:17', 0, 0),
(418, 'plg_search_contacts', 'plugin', 'contacts', 'search', 0, 1, 1, 0, '{"legacy":false,"name":"plg_search_contacts","type":"plugin","creationDate":"November 2005","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_SEARCH_CONTACTS_XML_DESCRIPTION","group":""}', '{"search_limit":"50","search_content":"1","search_archived":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(419, 'plg_search_content', 'plugin', 'content', 'search', 0, 1, 1, 0, '{"legacy":false,"name":"plg_search_content","type":"plugin","creationDate":"November 2005","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_SEARCH_CONTENT_XML_DESCRIPTION","group":""}', '{"search_limit":"50","search_content":"1","search_archived":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(420, 'plg_search_newsfeeds', 'plugin', 'newsfeeds', 'search', 0, 1, 1, 0, '{"legacy":false,"name":"plg_search_newsfeeds","type":"plugin","creationDate":"November 2005","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_SEARCH_NEWSFEEDS_XML_DESCRIPTION","group":""}', '{"search_limit":"50","search_content":"1","search_archived":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(421, 'plg_search_weblinks', 'plugin', 'weblinks', 'search', 0, 1, 1, 0, '{"legacy":false,"name":"plg_search_weblinks","type":"plugin","creationDate":"November 2005","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"PLG_SEARCH_WEBLINKS_XML_DESCRIPTION","group":""}', '{"search_limit":"50","search_content":"1","search_archived":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `v3xha_finder_filters`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_filters` (
  `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `state` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `v3xha_finder_links`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `v3xha_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `v3xha_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `state` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `v3xha_finder_taxonomy`
--

INSERT INTO `v3xha_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
  `node_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
...
--
-- Table structure for table `v3xha_finder_terms`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_terms` (
  `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `v3xha_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL,
  KEY `idx_word_lang` (`term`,`language`),
  KEY `idx_lang` (`language`)
...
--
-- Dumping data for table `v3xha_finder_terms_common`
--

INSERT INTO `v3xha_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `v3xha_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `v3xha_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `map_suffix` char(1) NOT NULL,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
...
--
-- Table structure for table `v3xha_finder_types`
--

CREATE TABLE IF NOT EXISTS `v3xha_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `mime` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `v3xha_languages`
--

CREATE TABLE IF NOT EXISTS `v3xha_languages` (
  `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `lang_code` char(7) NOT NULL,
  `title` varchar(50) NOT NULL,
  `title_native` varchar(50) NOT NULL,
...
--
-- Dumping data for table `v3xha_languages`
--

INSERT INTO `v3xha_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_menu`
--

CREATE TABLE IF NOT EXISTS `v3xha_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to #__menu_types.menutype',
  `title` varchar(255) NOT NULL COMMENT 'The display title of the menu item.',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
...
--
-- Dumping data for table `v3xha_menu`
--

INSERT INTO `v3xha_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(22, 'menu', 'com_joomlaupdate', 'Joomla! Update', '', 'Joomla! Update', 'index.php?option=com_joomlaupdate', 'component', 0, 1, 1, 28, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:joomlaupdate', 0, '', 41, 42, 0, '*', 1),
(101, 'mainmenu', 'Home', 'home', '', 'home', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","orderby_pri":"","orderby_sec":"front","order_date":"","multi_column_order":"1","show_pagination":"2","show_pagination_results":"1","show_noauth":"","article-allow_ratings":"","article-allow_comments":"","show_feed_link":"1","feed_summary":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_readmore":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":1,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 29, 30, 1, '*', 0),
(102, 'mainmenu', 'History', 'history', '', 'history', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","show_category":"0","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"0","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 43, 44, 0, '*', 0),
(103, 'mainmenu', 'Category', 'category', '', 'category', 'index.php?option=com_content&view=category&id=8', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_category_heading_title_text":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 50, 0, '*', 0),
(104, 'mainmenu', 'Sub cat.1', 'sub-cat-1', '', 'category/sub-cat-1', 'index.php?option=com_content&view=article&id=2', 'component', 1, 103, 2, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 46, 47, 0, '*', 0),
(105, 'mainmenu', 'Sub cat.2', 'sub-cat-2', '', 'category/sub-cat-2', 'index.php?option=com_content&view=article&id=3', 'component', 1, 103, 2, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 48, 49, 0, '*', 0),
(106, 'mainmenu', 'News', 'news', '', 'news', 'index.php?option=com_content&view=category&layout=blog&id=9', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"layout_type":"blog","show_category_heading_title_text":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","show_subcategory_content":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"0","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"0","link_author":"0","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"0","show_hits":"0","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 0, '*', 0),
(108, 'contact', 'Email', 'email', '', 'email', 'index.php?option=com_contact&view=contact&id=1', 'component', 1, 1, 1, 8, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"presentation_style":"","show_contact_category":"","show_contact_list":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","show_links":"","linka_name":"","linkb_name":"","linkc_name":"","linkd_name":"","linke_name":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 55, 56, 0, '*', 0),
(112, 'main', 'COM_DJIMAGESLIDER', 'com-djimageslider', '', 'com-djimageslider', 'index.php?option=com_djimageslider', 'component', 0, 1, 1, 10001, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_djimageslider/assets/icon-16-djimageslider.png', 0, '', 57, 62, 0, '', 1),
(113, 'main', 'COM_DJIMAGESLIDER_SLIDES', 'com-djimageslider-slides', '', 'com-djimageslider/com-djimageslider-slides', 'index.php?option=com_djimageslider&view=items', 'component', 0, 112, 2, 10001, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_djimageslider/assets/icon-16-menu-slides.png', 0, '', 58, 59, 0, '', 1),
(114, 'main', 'COM_DJIMAGESLIDER_CATEGORIES', 'com-djimageslider-categories', '', 'com-djimageslider/com-djimageslider-categories', 'index.php?option=com_categories&extension=com_djimageslider', 'component', 0, 112, 2, 10001, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:category', 0, '', 60, 61, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_menu_types`
--

CREATE TABLE IF NOT EXISTS `v3xha_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL,
  `title` varchar(48) NOT NULL,
  `description` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `v3xha_menu_types`
--

INSERT INTO `v3xha_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site'),
...
--
-- Table structure for table `v3xha_messages`
--

CREATE TABLE IF NOT EXISTS `v3xha_messages` (
  `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id_from` int(10) unsigned NOT NULL DEFAULT '0',
  `user_id_to` int(10) unsigned NOT NULL DEFAULT '0',
  `folder_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `v3xha_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `v3xha_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) NOT NULL DEFAULT '',
  `cfg_value` varchar(255) NOT NULL DEFAULT '',
  UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`)
...
--
-- Table structure for table `v3xha_modules`
--

CREATE TABLE IF NOT EXISTS `v3xha_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL DEFAULT '',
  `note` varchar(255) NOT NULL DEFAULT '',
  `content` text NOT NULL,
...
--
-- Dumping data for table `v3xha_modules`
--

INSERT INTO `v3xha_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"0","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(2, 'Login', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 'Popular Articles', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 'Recently Added Articles', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
...
(79, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 'Contact', '', '', 0, 'middle_bottom_2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_footer', 1, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(88, 'Bottom', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"contact","startLevel":"1","endLevel":"2","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(89, 'Most Read mod', '', '', 1, 'left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_articles_popular', 1, 1, '{"catid":[""],"count":"5","show_front":"1","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(90, 'Statistics mod', '', '', 1, 'middle_bottom_1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_stats', 1, 1, '{"serverinfo":"0","siteinfo":"1","counter":"0","increase":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(91, 'Random Image mod', '', '', 1, 'above_columns_2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_random_image', 1, 1, '{"type":"jpg","folder":"images\\/slider\\/","link":"","width":"","height":"","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 0, '*'),
(92, 'Logo', '', '<h1>Logo for TEMPLATE</h1>', 1, 'logo', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 1, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_modules_menu`
--

CREATE TABLE IF NOT EXISTS `v3xha_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `v3xha_modules_menu`
--

INSERT INTO `v3xha_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `v3xha_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `v3xha_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `v3xha_overrider`
--

CREATE TABLE IF NOT EXISTS `v3xha_overrider` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) NOT NULL,
  `string` text NOT NULL,
  `file` varchar(255) NOT NULL,
...
--
-- Table structure for table `v3xha_redirect_links`
--

CREATE TABLE IF NOT EXISTS `v3xha_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(255) NOT NULL,
  `new_url` varchar(255) NOT NULL,
  `referer` varchar(150) NOT NULL,
...
--
-- Table structure for table `v3xha_schemas`
--

CREATE TABLE IF NOT EXISTS `v3xha_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `v3xha_schemas`
--

INSERT INTO `v3xha_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.14'),
(10001, '2.0');
...
--
-- Table structure for table `v3xha_session`
--

CREATE TABLE IF NOT EXISTS `v3xha_session` (
  `session_id` varchar(200) NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `guest` tinyint(4) unsigned DEFAULT '1',
  `time` varchar(14) DEFAULT '',
...
--
-- Dumping data for table `v3xha_session`
--

INSERT INTO `v3xha_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('48f46ef3e5a1c54a4ff707d155d13ef0', 1, 0, '1382528808', '__default|a:8:{s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:20.0) Gecko/20100101 Firefox/20.0";s:15:"session.counter";i:110;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":10:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:11:"com_modules";O:8:"stdClass":3:{s:7:"modules";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":8:{s:18:"client_id_previous";i:0;s:6:"search";s:0:"";s:6:"access";i:0;s:5:"state";s:0:"";s:8:"position";s:0:"";s:6:"module";s:0:"";s:9:"client_id";i:0;s:8:"language";s:0:"";}s:10:"limitstart";i:0;s:8:"ordercol";s:7:"a.title";s:9:"orderdirn";s:3:"asc";}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":1:{s:4:"data";N;}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:13:"com_installer";O:8:"stdClass":3:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";s:12:"redirect_url";N;}s:11:"com_plugins";O:8:"stdClass":2:{s:7:"plugins";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":4:{s:6:"search";s:0:"";s:6:"access";i:0;s:5:"state";s:0:"";s:6:"folder";s:0:"";}s:10:"limitstart";s:1:"0";s:8:"ordercol";s:4:"name";s:9:"orderdirn";s:3:"asc";}s:4:"edit";O:8:"stdClass":1:{s:6:"plugin";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:20;}}s:13:"com_templates";O:8:"stdClass":1:{s:6:"styles";O:8:"stdClass":1:{s:10:"limitstart";i:0;}}s:14:"com_categories";O:8:"stdClass":2:{s:10:"categories";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:9:"extension";s:11:"com_content";}}s:4:"edit";O:8:"stdClass":1:{s:8:"category";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}}s:17:"com_djimageslider";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":1:{s:4:"data";N;}}}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":2:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}s:10:"limitstart";i:0;}s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":4:{s:2:"id";a:0:{}s:4:"data";N;s:4:"type";N;s:4:"link";N;}}}s:11:"com_content";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":1:{s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"316";s:4:"name";s:10:"Super User";s:8:"username";s:4:"root";s:5:"email";s:19:"galina.ck@gmail.com";s:8:"password";s:65:"74c3d4dac557013b34ba4459ffd344e3:BrFpFZYccSj0znne7Y3KbkyMGZ1M2SGA";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-20 18:29:31";s:13:"lastvisitDate";s:19:"2013-10-23 09:26:55";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"a57f504cb0997b60e260fa7e52cbbe22";s:19:"session.timer.start";i:1382526660;s:18:"session.timer.last";i:1382528788;s:17:"session.timer.now";i:1382528808;}', 316, 'root', '');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_template_styles`
--

CREATE TABLE IF NOT EXISTS `v3xha_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `home` char(7) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `v3xha_template_styles`
--

INSERT INTO `v3xha_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '0', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(6, 'beez5', 0, '0', 'Beez5 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/sampledata\\/fruitshop\\/fruits.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","html5":"0"}'),
(7, 'business_pro', 0, '1', 'business_pro - Default', '{"settings":""}');

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_updates`
--

CREATE TABLE IF NOT EXISTS `v3xha_updates` (
  `update_id` int(11) NOT NULL AUTO_INCREMENT,
  `update_site_id` int(11) DEFAULT '0',
  `extension_id` int(11) DEFAULT '0',
  `categoryid` int(11) DEFAULT '0',
...
--
-- Table structure for table `v3xha_update_categories`
--

CREATE TABLE IF NOT EXISTS `v3xha_update_categories` (
  `categoryid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT '',
  `description` text NOT NULL,
  `parent` int(11) DEFAULT '0',
...
--
-- Table structure for table `v3xha_update_sites`
--

CREATE TABLE IF NOT EXISTS `v3xha_update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` text NOT NULL,
...
--
-- Dumping data for table `v3xha_update_sites`
--

INSERT INTO `v3xha_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1382372619),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1382372619),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1382372619);

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `v3xha_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';
...
--
-- Dumping data for table `v3xha_update_sites_extensions`
--

INSERT INTO `v3xha_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `v3xha_usergroups`
--

CREATE TABLE IF NOT EXISTS `v3xha_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Adjacency List Reference Id',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `v3xha_usergroups`
--

INSERT INTO `v3xha_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `v3xha_users`
--

CREATE TABLE IF NOT EXISTS `v3xha_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `username` varchar(150) NOT NULL DEFAULT '',
  `email` varchar(100) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `v3xha_users`
--

INSERT INTO `v3xha_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(316, 'Super User', 'root', 'galina.ck@gmail.com', '74c3d4dac557013b34ba4459ffd344e3:BrFpFZYccSj0znne7Y3KbkyMGZ1M2SGA', 'deprecated', 0, 1, '2013-10-20 18:29:31', '2013-10-23 11:11:00', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_user_notes`
--

CREATE TABLE IF NOT EXISTS `v3xha_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) NOT NULL DEFAULT '',
...
--
-- Table structure for table `v3xha_user_profiles`
--

CREATE TABLE IF NOT EXISTS `v3xha_user_profiles` (
  `user_id` int(11) NOT NULL,
  `profile_key` varchar(100) NOT NULL,
  `profile_value` varchar(255) NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `v3xha_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `v3xha_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `v3xha_user_usergroup_map`
--

INSERT INTO `v3xha_user_usergroup_map` (`user_id`, `group_id`) VALUES
(316, 8);

-- --------------------------------------------------------

--
-- Table structure for table `v3xha_viewlevels`
--

CREATE TABLE IF NOT EXISTS `v3xha_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `v3xha_viewlevels`
--

INSERT INTO `v3xha_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
(2, 'Registered', 1, '[6,2,8]'),
(3, 'Special', 2, '[6,3,8]');
...
--
-- Table structure for table `v3xha_weblinks`
--

CREATE TABLE IF NOT EXISTS `v3xha_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `sid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL DEFAULT '',
